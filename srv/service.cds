...
service ZHR_COMP_CAP_CRVEXCEP_SRV {
    entity THRSHLD as projection on compmodel.ZHR_COMP_TBL_THRSHLD_MASTER;
    entity SUBZONE as projection on compmodel.ZHR_COMP_TBL_SUBZONE_MASTER;
    entity COMPRATIO as projection on compmodel.ZHR_COMP_TBL_COMPRATIO_MASTER;  
    entity CRV_EXPTN as projection on compmodel.ZHR_COMP_TBL_CRV_EXPTN_MASTER;
    entity BUDIV as projection on compmodel.ZHR_COMP_TBL_BUDIV_MASTER;
    entity TARGETTAB as projection on compmodel.ZHR_COMP_TBL_TARGETTAB_MASTER;
